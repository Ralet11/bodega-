...
const Login = () => {
  ...
  return (
    <div className="w[100%] h[100%] bgLogin">
    <div className="flex justify-center items-center min-h-screen max-w-[400px] ml-percent-10 bg-cover bg-center">
        ...
        <div className="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0">
          <div className="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
            ...
            <div className="flex flex-wrap px-3 -mx-3 sm:px-6 xl:px-12">
              ...
              <a className=" inline-block w-full px-6 py-3 mb-4 font-bold text-center text-gray-200 uppercase align-middle transition-all bg-transparent border border-gray-200 border-solid rounded-lg shadow-none cursor-pointer hover:scale-102 leading-pro text-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 hover:bg-transparent hover:opacity-75" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
            ...
            <div className="flex-auto p-6">
              <form onSubmit={handleSubmit} role="form text-left">
                ...
                <p className="mt-4 mb-0 leading-normal text-sm">Dont have an account? <a className="font-bold text-slate-700" href="../pages/sign-in.html">Sign up</a></p>
              </form>
            </div>
          </div>
        </div>
