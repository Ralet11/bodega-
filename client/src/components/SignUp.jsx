         ...
         {/*  <div className="relative z-0 min-w-0 break-words bg-black border-0 shadow-soft-xl rounded-2xl bg-clip-border w-4/12 h-400 overflow-hidden">
            ...
            <div className="relative z-0 flex flex-col min-w-0 break-words bg-black border-0 shadow-soft-xl rounded-2xl bg-clip-border">
              <div className="p-6 mb-0 text-center  border-b-0 rounded-t-2xl">
                <h5 className="text-center text-6xl font-bold leading-9 tracking-tight text-yellow-600 p-12 filter brightness-110">Sign up</h5>
              </div>
              <div className="flex flex-wrap px-3 -mx-3 sm:px-6 xl:px-12">
                ...
                <div className="text-center relative w-full">
                  <button onClick={handleSubmit} type="submit" className="bg-yellow-600 w-full relative">
                ...
                <p className="mt-4 mb-0 leading-normal text-white text-sm">Don't have an account? <a className="font-bold cursor-pointer text-white hover:text-yellow-400">Sign up</a></p>
              </div>
            </div>
